...
in
  rec {
    ...
    sessionVariables = {
      QT_XKG_CONFIG_ROOT = "/usr/share/X11/xkb";
      ...
      _FASD_DATA = "${config.xdg.dataHome}/fasd/fasd.data";
      _Z_DATA = "${config.xdg.dataHome}/fasd/z.data";
      CARGO_HOME = "${config.xdg.dataHome}/cargo";
      RUSTUP_HOME = "${config.xdg.dataHome}/rustup";
      TEXMFHOME = "${config.xdg.dataHome}/texmf";
      # QMK_HOME = "${home_directory}/Documents/gits/qmk";
      _ZO_ECHO = 1;
    ...
    packages = with pkgs; [
      ...
      #pkgs.callPackage ./includes/rofi.nix
      ...
      plugins = with pkgs; [
        ...
        }
        {
          ...
          extraConfig = ''
            ...
            set -g @resurrect-dir '${config.xdg.dataHome}/tmux-resurrect/data'
          '';
        }
      ];
      extraConfig = ''
